---
title: "Muestra con compañeros de trabajo de grado y creación de Quartz"
date: 2026-06-10
tags: [metodologia, muestra, quartz, obsidian, trabajo-de-grado, ia-generativa, comunicaciones]
---
...
El proyecto no solo observaría cómo los estudiantes usan IA, sino que diseñaría una experiencia de acompañamiento para que los compañeros:

- organicen su investigación en Obsidian;
- usen IA generativa con criterios de autoría, verificación y transparencia;
- creen flujos de trabajo para investigación y escritura;
- publiquen una versión navegable de su proceso en Quartz;
- reflexionen sobre cómo cambia su relación con la escritura, la investigación y la comunicación académica.
...
Se seleccionan participantes cercanos al investigador porque:

- están desarrollando trabajo de grado;
- tienen necesidades reales de organización, escritura y comunicación académica;
- pueden participar durante el semestre;
- permiten hacer seguimiento cercano al proceso;
- representan un grupo pertinente para una experiencia piloto.

### Tamaño recomendado

Para un semestre, lo ideal sería:

- **4 a 6 compañeros de trabajo de grado** como muestra principal;
- opcionalmente **1 o 2 docentes/asesores** para validar la utilidad del proceso;
- máximo **8 participantes**, para no volver inmanejable el acompañamiento.
...
- cómo cambia la forma de comunicar su investigación;
- qué tensiones aparecen sobre autoría, dependencia, privacidad y exposición pública;
- qué tan viable es publicar avances académicos en un sitio abierto.
...
- Es muy viable en un semestre.
- Los participantes tienen una necesidad real.
- Permite crear un producto aplicado útil.
- Se conecta directamente con Comunicaciones: escritura, publicación, mediación, circulación de conocimiento y cultura digital.
- Permite analizar IA y Quartz como mediaciones comunicativas.
- Puedes usar tu propio sitio como caso demostrativo.

## Riesgos o límites

- La muestra es pequeña y cercana al investigador, por lo que no permite generalización.
- Puede haber sesgo porque son compañeros conocidos.
- No todos tendrán el mismo nivel técnico.
- Algunos podrían no querer publicar su investigación en abierto.
- GitHub/Quartz puede tener barreras técnicas iniciales.

## Cómo manejar esos riesgos

- Presentar el estudio como experiencia piloto, no como investigación representativa.
- Usar consentimiento informado.
- Permitir que los participantes publiquen solo lo que quieran compartir.
- Ofrecer una opción privada de Obsidian para quienes no deseen publicar todo.
- Analizar tanto logros como dificultades técnicas.
- Dejar claro que el objetivo no es evaluar a los compañeros, sino analizar la apropiación de flujos y herramientas.
