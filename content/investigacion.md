...
La inteligencia artificial generativa se ha incorporado aceleradamente a las prácticas académicas universitarias. ChatGPT, Gemini, Claude, Copilot y otros asistentes conversacionales son utilizados por estudiantes para buscar información, formular ideas, resumir textos, organizar borradores, preparar productos comunicativos y recibir retroalimentación inicial (Lo, 2023; Kasneci et al., 2023). Esta incorporación no ocurre al margen de la formación: modifica prácticas centrales como investigar, leer, escribir, argumentar, verificar y citar (Crompton y Burke, 2023; Zawacki-Richter et al., 2019). En el caso de los trabajos de grado de la Facultad de Comunicaciones de la Universidad de Antioquia, el problema no es únicamente si los estudiantes usan o no IA generativa, sino cómo la usan para pensar, investigar, escribir y tomar decisiones académicas, en un contexto donde Chan y Hu (2023) muestran que los estudiantes perciben beneficios pero también expresan dudas sobre exactitud, dependencia y orientación institucional.

### Naturaleza del problema

La naturaleza del problema es comunicativa y formativa. Cuando la IA generativa interviene en la búsqueda, la síntesis, la revisión y la escritura, no opera como un instrumento neutral: se ubica en una red de mediaciones entre estudiante, docente, texto, fuente, plataforma y criterios de legitimidad académica (Martín-Barbero, 1987; Dwivedi et al., 2023). Las respuestas que produce suelen presentarse con fluidez y seguridad aun cuando contienen errores, sesgos, omisiones o referencias inexistentes (Walters y Wilder, 2023). Esto genera una tensión central para el pensamiento crítico: ¿cómo conserva el estudiante su agencia cuando una parte del proceso de búsqueda, argumentación y escritura se delega en un sistema generativo? En la escritura académica, la IA puede apoyar la generación de ideas, la estructura textual y la retroalimentación (Imran y Almusharraf, 2023; Mahapatra, 2024; Banihashem et al., 2024), pero también puede debilitar la lectura crítica, la construcción de argumento y la responsabilidad autoral si se usa como sustituto del juicio del estudiante.

### Perspectiva teórica

Desde el campo de las Comunicaciones, esta tensión se examina mejor como una cuestión de mediación: la IA reconfigura las prácticas mediante las cuales los estudiantes preguntan, interpretan fuentes, organizan información, argumentan y comunican conocimiento (Miao y Holmes, 2023). La evidencia reciente advierte, además, que el uso intensivo de IA generativa puede asociarse a reducciones en el esfuerzo cognitivo percibido y a una mayor dependencia cognitiva (Lee et al., 2025; Gerlich, 2025; Risko y Gilbert, 2016), y que persisten problemas de integridad académica, autoría y declaración de uso que exigen criterios pedagógicos explícitos (Perkins, 2023; Perkins et al., 2024; Cotton et al., 2024).

### Vacío investigativo

La brecha investigativa que justifica este proyecto es la siguiente: aunque la literatura documenta ampliamente oportunidades, riesgos éticos e impactos generales del uso de IA en educación superior, son escasos los estudios situados que diseñen, implementen y analicen flujos de trabajo concretos con IA generativa —secuencias articuladas de formulación, verificación, contraste, revisión y declaración— para observar cómo estudiantes de Comunicación problematizan y ejercen el pensamiento crítico en procesos reales de investigación y escritura académica. En América Latina, la investigación sobre IA en educación superior es aún incipiente y predominantemente técnica (Salas-Pilco y Yang, 2022). Esta investigación busca aportar a esa brecha mediante una propuesta aplicada en la Facultad de Comunicaciones de la Universidad de Antioquia.

## Pregunta de investigación

**¿De qué manera los flujos de trabajo con inteligencia artificial generativa median en el pensamiento crítico durante los procesos de investigación y escritura académica de estudiantes de trabajo de grado de la Facultad de Comunicaciones de la Universidad de Antioquia?**
